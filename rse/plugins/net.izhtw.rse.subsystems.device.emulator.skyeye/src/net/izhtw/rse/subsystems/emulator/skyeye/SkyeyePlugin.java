package net.izhtw.rse.subsystems.emulator.skyeye;
...
import net.izhtw.rse.subsystems.emulator.skyeye.adapter.SkyeyeSubSystemConfigurationAdapterFactory;
import net.izhtw.rse.subsystems.emulator.skyeye.adapter.SkyeyeSystemViewAdapterFactory;

public class SkyeyePlugin extends SystemBasePlugin {

	public static final String PLUGIN_ID = "net.izhtw.rse.subsystems.emulator.skyeye";
