package net.izhtw.rse.subsystems.emulator.local.adapter;
...
import net.izhtw.rse.subsystems.emulator.core.EmulatorConstants;
import net.izhtw.rse.subsystems.emulator.core.model.Emulator;
import net.izhtw.rse.subsystems.emulator.local.LocalEmulatorPlugin;
